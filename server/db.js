...
const seedData = async () => {
  ...
  await createUser({ username: "johnathan", password: "j", photo_URL: "", is_admin: true });
  await createUser({ username: "paul123", password: "p", photo_URL: "", is_admin: false });
  await createUser({ username: "ryan232", password: "r", photo_URL: "", is_admin: false });
  await createUser({ username: "eric567", password: "e", photo_URL: "", is_admin: false });
  await createUser({ username: "esti867", password: "e", photo_URL: "", is_admin: false });
  await createUser({ username: "erin2002", password: "e", photo_URL: "", is_admin: false });
  await createUser({ username: "jackson582", password: "j", photo_URL: "", is_admin: false });
  await createUser({ username: "drpepperfanatic4290", password: "d", photo_URL: "", is_admin: false });
  await createUser({ username: "jareds1070", password: "j", photo_URL: "", is_admin: true });
  await createUser({ username: "drpeppersucks", password: "d", photo_URL: "", is_admin: false });
  await createUser({ username: "adam392", password: "a", photo_URL: "", is_admin: false });
  await createUser({ username: "kenzi392", password: "k", photo_URL: "", is_admin: false });
